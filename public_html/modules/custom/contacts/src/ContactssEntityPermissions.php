...
use Drupal\contacts\Entity\ContactssEntity;


/**
 * Provides dynamic permissions for Contactss entity of different types.
 *
 * @ingroup contacts
 *
 */
class ContactssEntityPermissions{
   ...
   *
   * @return array
   *   The ContactssEntity by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (ContactssEntity::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\contacts\Entity\ContactssEntity $type
   *   The ContactssEntity type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(ContactssEntity $type) {
    $type_id = $type->id();
